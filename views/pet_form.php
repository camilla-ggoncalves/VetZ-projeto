    ...
    <div class="form-container">
      <div class="form-card">
        <div class="form-header">
          <h2><i class="fas fa-paw"></i> Cadastrar Pet</h2>
          <p>Preencha os dados do seu pet</p>
        </div>

        <form action="<?php echo url('/save-pet'); ?>" method="POST" enctype="multipart/form-data">
          <input type="hidden" name="id" value="<?= $pet['id'] ?? '' ?>">

          <div class="form-group">
            <label for="nome"><i class="fas fa-tag"></i> Nome do Pet</label>
            <input type="text" id="nome" name="nome" placeholder="Ex: Rex, Mia, Bob..." required>
          </div>

          <div class="form-group">
            <label for="raca"><i class="fas fa-dog"></i> Raça</label>
            <input type="text" id="raca" name="raca" placeholder="Ex: Labrador, Persa, SRD..." required>
          </div>

          <div class="form-row">
            <div class="form-group">
              <label for="idade"><i class="fas fa-calendar-alt"></i> Idade</label>
              <input type="number" id="idade" name="idade" placeholder="Anos" min="0">
            </div>

            <div class="form-group">
              <label for="peso"><i class="fas fa-weight"></i> Peso (kg)</label>
              <input type="number" id="peso" name="peso" placeholder="Ex: 5.5" step="0.1" min="0" required>
            </div>
          </div>
          ...
          <div class="form-group">
            <label for="imagem"><i class="fas fa-image"></i> Imagem do Pet</label>
            <input type="file" id="imagem" name="imagem" accept="image/*">
          </div>

          <button type="submit" class="btn-submit">
            <i class="fas fa-check-circle"></i> Cadastrar Pet
          </button>
